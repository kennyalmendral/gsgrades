								...
								<?php foreach ($sessions as $session): ?>
									<tr>
										...
										<td valign="middle" class="text-center">
											<button class="edit-session-button btn btn-outline-primary btn-sm me-1" title="Edit session"><i class="bi bi-pencil d-none"></i><i class="bi bi-pencil-fill"></i></button>

                            				<button class="delete-session-button btn btn-outline-danger btn-sm" title="Delete session"><i class="bi bi-trash d-none"></i><i class="bi bi-trash-fill"></i></button>
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
